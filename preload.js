...
contextBridge.exposeInMainWorld('journal', {
  ...
  disableEncryption: (pin, opts) => ipcRenderer.invoke('security:disable', pin, opts || {}),
  changeEncryptionPin: (currentPin, newPin, opts) => ipcRenderer.invoke('security:change-pin', currentPin, newPin, opts || {}),
